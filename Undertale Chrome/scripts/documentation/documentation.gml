function getDocumentation()
{
	...
	fixed = [
		...
		" - BATTLE - Soul changes with soul selected",
		" - STATS - Soul selection is reflected in stats",
		" - Soul bullets reflect soul color",
		" - Save improvements!",
		" - Battle Bypass for Boss Fights and Cutscenes",
		" - Dialogue ONLY Bullet Patterns that end when dialogue is done (60 frames)", 
		" - Can set flags via oBattleStartTrigger for dialogue only, hide menu, bypass battle",
		" - [NOT DOING] Add FUNCTIONALITY to ITEMS",
		" - Add FUNCTIONALITY to SOUL in BATTLE MENU",
		" - Save battle triggers that were defeated in specific rooms when saving game",
		" - Delete Battle Trigger in room based on save file",
	]; 

	todos = [
		"","************************* TODOS *************************",
		" - [NEED] Add in Sequence Support with Cutscene System or update Current Cutscene System",
