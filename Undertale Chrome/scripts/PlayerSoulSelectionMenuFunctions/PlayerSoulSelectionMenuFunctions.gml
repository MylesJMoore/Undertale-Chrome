...
/// @function getSoulNameIndex
function getSoulNameIndex(_name) {
	var _index = 0;
	switch (_name)
	{
	    case "Resilience":
	        _index = RESILIENCE_INDEX;
	    break;

	    case "Determination":
	        _index = DETERMINATION_INDEX;
	    break;
		
		case "Bravery":
	        _index = BRAVERY_INDEX;
	    break;
		
		case "Justice":
	        _index = JUSTICE_INDEX;
	    break;
		
		case "Kindness":
	        _index = KINDNESS_INDEX;
	    break;
		
		case "Patience":
	        _index = PATIENCE_INDEX;
	    break;
		
		case "Integrity":
	        _index = INTEGRITY_INDEX;
	    break;
		
		case "Perseverance":
	        _index = PERSEVERANCE_INDEX;
	    break;
	}
