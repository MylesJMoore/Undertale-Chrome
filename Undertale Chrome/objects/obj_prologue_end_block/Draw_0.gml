...
if(show_save_option) {
	...
	{
	    case "resilience":
	        draw_sprite_ext(spr_soul_selection_left, 0, player_name_text_x + 40, player_name_text_y + 87, .5, .5, 0, c_white, 1);
			draw_sprite_ext(spr_soul_selection_right, global.soul_selected, player_name_text_x + 39, player_name_text_y + 87, .5, .5, 0, c_white, 1);
			draw_set_color(c_yellow);
			draw_text_ext_transformed(player_name_text_x + 50, player_name_text_y + 80, "Resilience", 500, 500, 1, 1, image_angle);
			draw_set_color(c_white);
			draw_text_ext_transformed(player_name_text_x + 170, player_name_text_y + 80, "Fear", 500, 500, 1, 1, image_angle);
	    break;

	    case "fear":
	        draw_sprite_ext(spr_soul_selection_left, 0, player_name_text_x + 160, player_name_text_y + 87, .5, .5, 0, c_white, 1);
			draw_sprite_ext(spr_soul_selection_right, global.soul_selected, player_name_text_x + 159, player_name_text_y + 87, .5, .5, 0, c_white, 1);
			draw_set_color(c_white);
			draw_text_ext_transformed(player_name_text_x + 50, player_name_text_y + 80, "Resilience", 500, 500, 1, 1, image_angle);
			draw_set_color(c_yellow);
			draw_text_ext_transformed(player_name_text_x + 170, player_name_text_y + 80, "Fear", 500, 500, 1, 1, image_angle);
