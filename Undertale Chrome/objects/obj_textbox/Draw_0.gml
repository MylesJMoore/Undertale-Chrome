...
if(speaker_sprite[page] != noone) 
{
	...
	//Draw the Speaker
	var _xscale = sprite_width/textbox_sprite_width;
	var _yscale = sprite_height/textbox_sprite_height;
	draw_sprite_ext(textbox_sprite[page],textbox_image, textbox_x + portrait_x_offset[page],textbox_y, _xscale, _yscale,0, c_white, 1);
